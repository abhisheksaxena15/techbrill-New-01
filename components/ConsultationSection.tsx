...
export default function ConsultationSection({ bgImage = "/images/services/web-design-hero.jpg" }) {
  return (
    ...
    <section className="relative flex flex-col md:flex-row min-h-[70vh] w-full md:py-16 overflow-hidden">
      ...
      />
      <div className="absolute inset-0 z-10 bg-gradient-to-r from-[#4c1d95] via-[#120624] to-[#0891b2] opacity-30" />
      {/* Content */}
      <div className="relative z-20 flex-1 flex flex-col justify-center items-center px-8 py-12 text-white dark:text-white text-gray-900">
    ...
    <section className="relative min-h-[70vh] w-full md:py-16">
      <Image src="/images/consultation-section.jpg" alt="Web Design Hero" fill className="object-cover object-center z-0" priority />
      {/* Updated gradient overlay for better blending */}
