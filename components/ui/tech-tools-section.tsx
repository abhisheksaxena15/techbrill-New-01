...
const techTabs = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Express.js", icon: <Icon icon="logos:express" className="w-7 h-7" color="#3b82f6" /> },
      ...
      { name: "Prisma", icon: <Icon icon="logos:prisma" className="w-7 h-7" color="#3b82f6" /> },
    ],
  },
  {
    ...
    skills: [
      ...
      { name: "Vercel", icon: <Icon icon="logos:vercel-icon" className="w-7 h-7" color="#3b82f6" /> },
      { name: "Netlify", icon: <Icon icon="logos:netlify" className="w-7 h-7" /> },
      { name: "GitHub Actions", icon: <Icon icon="logos:github-actions" className="w-7 h-7" color="#3b82f6" /> },
      { name: "Jenkins", icon: <Icon icon="logos:jenkins" className="w-7 h-7" color="#3b82f6" /> },
    ],
  },
];
    ...
    >
      <div className="mx-auto w-full max-w-[1100px]">
        <div className="flex flex-col md:grid md:grid-cols-[1fr_2.3fr] gap-0 items-stretch rounded-3xl overflow-hidden shadow-sm">
          {/* Left: Domain Tabs */}
          <div className="bg-blue-700 text-white p-4 flex flex-col gap-4 overflow-y-auto max-h-[340px] min-h-[340px] scrollbar-thin scrollbar-thumb-blue-400 scrollbar-track-blue-500">
              ...
              <button
                ...
                className={`flex justify-between items-center px-4 py-3 rounded-xl text-left transition-all font-medium ${
                  activeTab === idx
                    ...
                    : "hover:bg-blue-600/80 opacity-80"
                }`}
