...
// 						<h2 className="text-lg font-semibold uppercase tracking-wide text-blue-700 dark:text-white">
// 							What We Do
// 						</h2>
// 						<h2 className="text-xl sm:text-3xl font-bold text-gray-900 md:text-4x">Transforming ideas into flawless <span className="text-blue-700 font-bold italic">web experiences solutions</span>  is our expertise </h2>
// 						<div className="h-1 w-20 bg-blue-500 mx-auto mt-4 mb-3"></div>
// 						<h3 className=" text-xs text-gray-600  md:text-lg  max-w-3xl mx-auto  leading-relaxed mb-3">
// 							We provide end-to-end web design and development solutions that empower businesses to grow, adapt, and succeed in today’s fast-paced digital world.                </h3>
