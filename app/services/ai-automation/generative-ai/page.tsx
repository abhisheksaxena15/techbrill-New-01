...
import { ArrowRight, TrendingUp, Users, Target, Search, MessageCircle, Award, Calendar, BarChart3, ThumbsUp, DollarSign, Headphones, Truck, Shield, Settings, Palette } from 'lucide-react';
          ...
          >
            <div className="h-[40rem] w-full rounded-md relative bg-transparent dark:bg-transparent flex flex-col items-center justify-center antialiased">
              <div className="max-w-2xl mx-auto p-4 mb-5">
                ...
                >
                  Unlocking creativity and efficiency with Generative AI solutions
                </motion.p>
              </div>
              <motion.div
              ...
              <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-8 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl">
                <div className="grid grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Customer Support</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/30 rounded-xl flex items-center justify-center mx-auto mb-3">
                      <Truck className="w-6 h-6 text-purple-600 dark:text-purple-400" />
                    </div>
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Supply Chain Management</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-green-100 dark:bg-green-900/30 rounded-xl flex items-center justify-center mx-auto mb-3">
                      <Users className="w-6 h-6 text-green-600 dark:text-green-400" />
                    </div>
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Customer Service</p>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Predictive Maintenance</p>
                  </div>
                  <div className="text-center">
                    ...
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Image Creation</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Generate high-quality text, images, and other media automatically, saving time and resources
                </p>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Explore new ideas and creative possibilities with AI-powered generation and suggestions.
                </p>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Accelerated Development</h3>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Speed up software development with AI-assisted code generation and debugging.
                </p>
              </div>
            </motion.div>
          </motion.div>
